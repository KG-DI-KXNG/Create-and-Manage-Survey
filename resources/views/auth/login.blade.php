    ...
    <div class="max-w-md w-full space-y-8 p-10 bg-white rounded-xl z-10">
      ...
      <form class="mt-2 space-y-6" method="POST" action="{{ route('login') }}">
        ...
        <div class="mt-4 content-center">
          ...
          <x-input id="password" class="block mt-1 w-full border-b" type="password" name="password" required autocomplete="current-password"/> 
        </div>
        ...
        <p class="flex flex-col items-center justify-center mt-10 text-center text-md text-gray-500">
          ...
          <a class="text-indigo-500 hover:text-indigo-500no-underline hover:underline cursor-pointer transition ease-in duration-300"  href="{{route('register')}}">{{__('Sign up')}}
          </a>
        </p>
